...
Public Class Login
    ...
    Private Sub Login_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            cnx.ConnectionString = "Server=kuhibot.sytes.net;Port=3306;Database=kuhiscan;Uid=root;Pwd=gtl929t8a54kj2r9xykpzy55p2tp"
            ...
            Else
                ...
                MsgBox("Update needed!" + vbCrLf + "Download from: http://kuhibot.sytes.net")
                Application.Exit()
            End If
